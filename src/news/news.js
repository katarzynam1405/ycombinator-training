export default function createNews(stories){
    ...
    const newsHTML =
        ...
        <div class="news-list__post-info"><p class="score">Score: ${stories.points} |</p><p class="author">Author: ${stories.author} |</p><p class="comment">Comments: ${stories.num_comments ? stories.num_comments : 0 }</p><span class="show-comments"><img src="./src/assets/grayarrow.gif" alt="show comment"/></span></div>`;
